...
--->
<head>
	<title>Edit Moderator Phone</title>
	<style>
...
<cfform action="mod_edit_phone_action.cfm?speakerid=#URLEncodedFormat(speakerid)#&phone_id=#URLEncodedFormat(phone_id)#&no_menu='1'" method="POST" enablecab="Yes">
<table width="80%" border="0" cellspacing="2" cellpadding="2">
<tr>
	<td><b>Moderator ID:&nbsp;&nbsp;</b><cfoutput>#speakerid#</cfoutput></td>
