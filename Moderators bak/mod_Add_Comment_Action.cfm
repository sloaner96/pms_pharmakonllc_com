...
<html>
<head>
	<title>Add Moderator Comment action</title>
...
<cfquery name="qInsertNewComment" datasource="#application.speakerDSN#">
	...
	Values(#speakerid#,'MOD','#trim(Left(form.comment, 250))#', '#comment_type#', #Now()#, #session.userinfo.rowid#)
</cfquery>
...
<!--- if all queries performed ok, go back to details page. If not, give warning --->	
	...
	<cflocation url="mod_comments_details.cfm?speakerid=#speakerid#&sortby=#sortby#&order=#order#&no_menu='1'">
	<cfelse>
