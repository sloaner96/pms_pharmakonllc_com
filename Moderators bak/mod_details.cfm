<!--- sets sortby/order variables to be passed to MOD_Add_Comment.cfm  --->
 <link rel="stylesheet" type="text/css" media="all" href="/includes/styles/schedule.css" title="tas" />
<cfoutput>
<cfif isDefined("form.all_mod")>
<cfset url.speakerid= '#form.all_mod#'></cfif>
</cfoutput>
...
<cfquery name="qcomments" DATASOURCE="#application.speakerDSN#">
	SELECT  *
	FROM    comments
	WHERE   clientID =  '#speakerid#' AND type = 'MOD'
</cfquery>
...
<br>
<p>Click on the speakers name to edit information about the speaker.</p>
			...
			<table border="0" cellspacing="0" cellpadding="2" align="center" width="100%">
				<cfoutput query="qdetails">
				  <tr>
					 ...
					 <td></td>
					 <td colspan="3"><A HREF="MOD_edit.cfm?speakerid=#qdetails.speakerid#"><b style="font-size:14px;">#qdetails.firstname#&nbsp;#qdetails.middlename#&nbsp;#qdetails.lastname#&nbsp;#qdetails.degree#</b></a></td>
					</tr>
					<tr BGCOLOR="##eeeeee">
...
Select project_code, product
			...
			Where Left(project_code, 5) = '#clientcode#'
				...
				<tr BGCOLOR="#eeeeee">
					...
					<td></td>
					<td colspan="3"><a href="javascript:OpenWindow()"><strong>Check Availability</strong></a></td>
				</tr>
			    <tr>
