...
<cfquery name="qContact_details" datasource="#application.speakerDSN#">
	...
	FROM   Contact_info  
	WHERE  Contact_info.Contact_id =  #Contact_id# AND type = 'MOD'
	</cfquery>
...
<cfform action="mod_edit_Contacts_action.cfm?Contact_id=#URLEncodedFormat(Contact_id)#&speakerid=#speakerid#&no_menu='1'" method="POST" enablecab="Yes">	
