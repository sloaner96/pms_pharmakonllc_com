...
<cfoutput><table border="0" cellpadding="0" cellspacing="0" width="100%">
		        <tr>
		           <td align="left" valign="top"><cfform action="available_process.cfm" method="POST">
<font face="Verdana" size ="1"><strong>Unblock Full Days</strong>.</font><br><br>
...
<select name="endyear">		
						...
						To Block Out Unavailable time, <a href="unavailable.cfm"><u>click here</u></a>.</font>
</td>
<td valign="top" align="left"><cfform action="available_process.cfm" method="POST">
<font face="Verdana" size ="1"><strong>Unblock Time for a Day</strong>.</font><br><br>
...
<br><br><cfoutput><cfif isDefined("url.conflict")><center>
* <font face="Verdana" size="2" color="red">
You can not Unblock time out for #url.meetingdate#, for #current_spkr.firstname# #current_spkr.lastname#. #current_spkr.firstname# currently has a meeting scheduled on #url.meetingdate#. Please remove the meeting before blocking out the day.
...
<cfelse>
	 <div class="daycontent2" id="daycontent_#dayCounter#"><cfloop query="unavail_time1"><cfif unavail_time1.meetingcode is ''><font color = "red"></cfif>#TimeFormat(unavail_time1.availfromtime, "h:mm tt")# - #TimeFormat(unavail_time1.availtotime, "h:mm tt")#</font></font><!--- </cfif> ---><br></cfloop></div> </cfif>					
					   </td>
					   </cfoutput>
