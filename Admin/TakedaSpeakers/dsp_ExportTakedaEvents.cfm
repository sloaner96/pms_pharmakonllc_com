...
<cfscript>
		sLog = dataObj.lastEventLog('Events');
</cfscript>

<form action="act_ExportTakedaEvents.cfm?a=build" method="post" name="build_events">
	...
	<tr>
		...
		<center>The last Speaker Event Export was for dates:
