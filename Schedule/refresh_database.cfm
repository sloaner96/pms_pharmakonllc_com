...
<cfif isDefined("url.delete")>  
 <cfquery name="delete_entry" datasource="#application.projdsn#">
			 UPDATE schedule
	        SET
			<cfif #url.delete# is 'mod1'>
			Moderator1LastName = '',
			Moderator1FirstName = ''
			<cfelseif #url.delete# is 'mod2'>
			Moderator2LastName = '',
			Moderator2FirstName = ''
			<cfelseif #url.delete# is 'spkr1'>
			Speaker1LastName = '',
			Speaker1FirstName = ''
			<cfelseif #url.delete# is 'spkr2'>
			Speaker2LastName = '',
			Speaker2FirstName = ''
			</cfif>
...
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="Master Schedule-Data" bodyPassthrough="" doAjax="True">
 <table border="0" cellspacing="0" cellpadding="3" align="left" width="790">
 <tr>
...
<cfstoredproc procedure="pmsdev.dbo.sp_uploadschedule" datasource="dbmaster" returncode="Yes">
</cfstoredproc>   
    
	    <cfset stall_for_time = '#cfstoredproc.statusCode#'>
		
		<!--- Fix Date Format --->
		  <cfquery name="new_data" datasource="#application.projdsn#">
 Select Date, RowID from schedule 
  </cfquery> 
 <cfloop query="new_data">
  <cfquery name="update2" datasource="#application.projdsn#">
        UPDATE Schedule 
		SET			
		Date = '#DateFormat(new_data.Date, "m/d/yyyy")#' 
 	
		Where 
        RowID = '#Left(new_data.RowID, 9)#' 
		      </cfquery>	
			  </cfloop>	
               <!---  --->
...
<cfif #check_meeting_code.recordcount# is 0>	
			...
			<a href="refresh_database.cfm?delete=mod1&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>
...
Order by lastname
	...
	<cfif associated_mods1.recordcount eq 0>	
	<a href="refresh_database.cfm?delete=mod1&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>
...
Please modify your entry, or check this Moderators availability by <a href="javascript:openpopupunavail('../reports/report_modspkr_calendar2.cfm?no_menu=1.cfm&ID=#mod1id.speakerid#&year=#DateFormat(new_data.Date, 'yyyy')#&month=#DateFormat(new_data.Date, 'm')#')"><u>clicking here</u></a>.<br><br><hr size="1">
<cfset error = 'mod1'>
...
<font color="FF0000"><strong>Warning!</strong></font> #Trim(new_data.Moderator1FirstName)# #Trim(new_data.Moderator1LastName)# has been added to #Left(newMeetingCode, 9)#, #DateFormat(new_data.Date, "m/d/yyyy")# at #TimeFormat(new_data.Time, "h:mm tt")# however, #Trim(new_data.Moderator1FirstName)# #Trim(new_data.Moderator1LastName)# is in meeting #Left(check_avail1.MeetingCode, 9)# from #TimeFormat(check_avail1.availfromtime, "h:mm tt")# to #TimeFormat(check_avail1.availtotime, "h:mm tt")#.<br><br><hr size="1">
...
<cfif #check_meeting_code.recordcount# is 0>	
			...
			<a href="refresh_database.cfm?delete=mod2&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>
...
Order by lastname
	...
	<cfif associated_mods2.recordcount eq 0>	
	<a href="refresh_database.cfm?delete=mod2&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>
...
Please modify your entry, or check this Moderators availability by <a href="javascript:openpopupunavail('../reports/report_modspkr_calendar2.cfm?no_menu=1.cfm&ID=#mod2id.speakerid#&year=#DateFormat(new_data.Date, 'yyyy')#&month=#DateFormat(new_data.Date, 'm')#')"><u>clicking here</u></a>.<br><br><hr size="1">
<cfset error = 'mod2'>
...
<font color="FF0000"><strong>Warning!</strong></font> #Trim(new_data.moderator2FirstName)# #Trim(new_data.moderator2LastName)# has been added to #Left(newMeetingCode, 9)#, #DateFormat(new_data.Date, "m/d/yyyy")# at #TimeFormat(new_data.Time, "h:mm tt")# however, #Trim(new_data.moderator2FirstName)# #Trim(new_data.moderator2LastName)# is in meeting #Left(check_avail2.MeetingCode, 9)# from #TimeFormat(check_avail2.availfromtime, "h:mm tt")# to #TimeFormat(check_avail2.availtotime, "h:mm tt")#.<br><br><hr size="1">
...
<cfif #check_meeting_code.recordcount# is 0>	
			...
			<a href="refresh_database.cfm?delete=spkr1&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>
...
Order by lastname
	...
	<cfif associated_spkrs1.recordcount eq 0>	
	<a href="refresh_database.cfm?delete=spkr1&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>
...
Please modify your entry, or check this Speakers availability by <a href="javascript:openpopupunavail('../reports/report_modspkr_calendar2.cfm?no_menu=1.cfm&ID=#spkr1id.speakerid#&year=#DateFormat(new_data.Date, 'yyyy')#&month=#DateFormat(new_data.Date, 'm')#')"><u>clicking here</u></a>.<br><br><hr size="1">
<cfset error = 'spkr1'>
...
<font color="FF0000"><strong>Warning!</strong></font> #Trim(new_data.Speaker1FirstName)# #Trim(new_data.Speaker1LastName)# has been added to #Left(newMeetingCode, 9)#, #DateFormat(new_data.Date, "m/d/yyyy")# at #TimeFormat(new_data.Time, "h:mm tt")# however, #Trim(new_data.Speaker1FirstName)# #Trim(new_data.Speaker1LastName)# is in meeting #Left(check_avail3.MeetingCode, 9)# from #TimeFormat(check_avail3.availfromtime, "h:mm tt")# to #TimeFormat(check_avail3.availtotime, "h:mm tt")#.<br><br><hr size="1">
...
<cfif #check_meeting_code.recordcount# is 0>	
			...
			<a href="refresh_database.cfm?delete=spkr2&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>
...
Order by lastname
	...
	<cfif associated_spkrs2.recordcount eq 0>
	<a href="refresh_database.cfm?delete=spkr2&rowid=#new_data.RowID#"><font color="800000"><u>Delete Entry</u></font></a><br><br>	
...
Please modify your entry, or check this Speakers availability by <a href="javascript:openpopupunavail('../reports/report_modspkr_calendar2.cfm?no_menu=1.cfm&ID=#spkr2id.speakerid#&year=#DateFormat(new_data.Date, 'yyyy')#&month=#DateFormat(new_data.Date, 'm')#')"><u>clicking here</u></a>.<br><br><hr size="1">
<cfset error = 'spkr2'>
...
<font color="FF0000"><strong>Warning!</strong></font> #Trim(new_data.Speaker2FirstName)# #Trim(new_data.Speaker2LastName)# has been added to #Left(newMeetingCode, 9)#, #DateFormat(new_data.Date, "m/d/yyyy")# at #TimeFormat(new_data.Time, "h:mm tt")# however, #Trim(new_data.Speaker2FirstName)# #Trim(new_data.Speaker2LastName)# is in meeting #Left(check_avail4.MeetingCode, 9)# from #TimeFormat(check_avail4.availfromtime, "h:mm tt")# to #TimeFormat(check_avail4.availtotime, "h:mm tt")#.<br><br><hr size="1">
...
<cfset RowID1 = '#RowID#'>
 		...
 		<cfif error is ''>
	  <cflocation url="main.cfm" addtoken="No"> <cfelse>	  
	<br><br>  <a href="main.cfm"><strong><u>Back to Scheduling Main Page</u></strong></a><br>OR<br>
	<u><a href="grid/index.cfm" target="_blank">Modify this Meeting in the Dynamic Grid</a></u>	
