...
<cfif isDefined("URL.type")>
	<cfif #URL.type# EQ "mod">
		...
		<cfset typeof = 3><!---Moderators are identified by 3 in the database---->
	...
	<cfelseif #URL.type# EQ "spkr">
		...
		<cfset typeof = 6><!---Speakers are identified by 6 in the database---->
	</cfif>
<cfelse>
...
<!--- <CFQUERY DATASOURCE="#application.projdsn#" NAME="UpdateListens">			
	INSERT INTO listen_ins(meeting_date_id, meeting_rowid, modspkrid, spkr_client_rowid, type, add_meeting_date, updated, updated_userid) 
...
<CFQUERY DATASOURCE="#application.projdsn#" NAME="InsertListens">			
