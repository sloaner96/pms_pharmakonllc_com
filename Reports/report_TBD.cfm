...
------------------------->
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="TBD Report" showCalendar="1">
...
function OpenHTMLReport()
{
	...
	{
		document.forms[0].action = "report_TBD2.cfm?report=HTML";
...
function OpenExcelReport()
{
	...
	{
		document.forms[0].action = "report_TBD2.cfm?report=Excel&no_menu=1";
		document.forms[0].submit();
	}
}
</script>
...
<form action="report_TBD2.cfm" method="post" onsubmit="return CheckDates(this)">		
