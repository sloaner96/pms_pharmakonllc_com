...
<CFSWITCH EXPRESSION="#URL.action#">
	...
	<CFCASE VALUE="report">
 	...
 	<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="getunavailable">
		...
		WHERE speakerid = #form.person_id# AND (allday = 0 or allday = 2) AND (month BETWEEN #form.begin_month# AND #form.end_month#) AND (year BETWEEN #form.begin_year# AND #form.end_year#)
	...
	<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="getname">
		...
		FROM Speaker
		WHERE speakerid = #form.person_id#
	</CFQUERY> 
