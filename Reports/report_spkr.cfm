...
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="" showCalendar="0">

				<SCRIPT>
				function openNewWin()
				{
					window.open('report_spkr_popup.cfm?no_menu=1','title','scrollbars=yes,resizable=yes,width=750,height=600,left=1,top=1');
				}
				function openNewWin2()
				{
					window.open('report_spkr_popup2.cfm?no_menu=1','title','scrollbars=yes,resizable=yes,width=750,height=600,left=1,top=1');
				}
				</SCRIPT>
				<STYLE>
				...
				<TABLE ALIGN="left" BORDER="0" CELLPADDING="5" CELLSPACING="5">
					<TR>
						...
						<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="GetName">
							...
							FROM Speaker
							WHERE speakerid='#session.id#' AND type='SPKR'; 
						</CFQUERY>
					...
					<CFQUERY DATASOURCE="#application.projdsn#" NAME="meetingDT">
						...
						WHERE status = 0 AND speakerid = '#session.id#' AND month BETWEEN <CFOUTPUT>#begin_month#</CFOUTPUT> AND <CFOUTPUT>#end_month#</CFOUTPUT> AND year BETWEEN <CFOUTPUT>#begin_year#</CFOUTPUT> AND <CFOUTPUT>#end_year#</CFOUTPUT>
						...
						<TD COLSPAN="5">
								...
								<CFIF session.sort_selection EQ "Time">
									...
									<cfscript>
										...
										<TR>
											<TD STYLE="text-align: right; font-weight: bold;">#TheTime# EST<!--- #start_time# to #end_time# ---></TD>
											<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
								...
								<CFELSEIF session.sort_selection EQ "Date">
									...
									<cfscript>
										...
										<TR>
											...
											<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
											<TD>#TheTime# EST<!--- #start_time# to #end_time# ---></TD>
											<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
											<TD>
											<cfif StrLastCol NEQ #project_code#>
											#project_code#
					...
					<TR>
						<TD COLSPAN="5" STYLE="text-align: left; font-size : small;"><U>Day Availability Report</U> Day Availability Report</U></TD>
					</TR>
					<TR>
													...
													<CFOUTPUT>
														<CFIF #Evaluate('Month_Calendar.x#DayNumbers#')# EQ 1>
																<CFQUERY DATASOURCE="#application.projdsn#" NAME="Meetings">
																	SELECT *
																	FROM ScheduleSpeaker
																	WHERE month = '#DateFormat(temp_current_date, 'm')#' AND year = '#DateFormat(temp_current_date, 'yyyy')#' AND speakerid = '#session.ID#' AND day = '#DayNumbers#'
																</CFQUERY>
...
<CFDEFAULTCASE>
		...
		<HTML>
			...
			<BODY>
				<CFOUTPUT><FORM NAME="form" action="report_spkr.cfm?action=report" METHOD="post" onSubmit="return validate()"></CFOUTPUT>
								...
								<TR>
									<TD ALIGN="Center">
										...
										<SELECT NAME="person_id">
											<CFOUTPUT query="person"><OPTION VALUE=#speakerid#>#lastname#, #Firstname#</CFOUTPUT>
										</SELECT>	
									</TD>
								</TR>
