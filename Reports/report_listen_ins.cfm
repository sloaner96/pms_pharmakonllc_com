<!----------------------
report_listen_ins.cfm


------------------------->
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="Listen In Report" showCalendar="1">
...
function OpenHTMLReport()
{
	...
	{
		document.forms[0].action = "report_listen_ins2.cfm?report=HTML";
...
function OpenExcelReport()
{
	...
	{
		document.forms[0].action = "report_listen_ins2.cfm?report=Excel&no_menu=1";
		document.forms[0].submit();
	}
}
</script>
