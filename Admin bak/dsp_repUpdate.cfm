...
<HTML>
			<HEAD>
				...
				<LINK REL=stylesheet HREF="piw1style.css" TYPE="text/css">
				  <!-- calendar stylesheet -->
				  <link rel="stylesheet" type="text/css" media="all" href="/CGI-BIN/jscalendar1_0/calendar-blue.css" title="tas" />
				
				  <!-- main calendar program -->
				  <script type="text/javascript" src="/CGI-BIN/jscalendar1_0/calendar.js"></script>
				
				  <!-- language for the calendar -->
				  <script type="text/javascript" src="/CGI-BIN/jscalendar1_0/lang/calendar-en.js"></script>
				
				  <!-- the following script defines the Calendar.setup helper function, which makes
				       adding a calendar a matter of 1 or 2 lines of code. -->
				  <script type="text/javascript" src="/CGI-BIN/jscalendar1_0/calendar-setup.js"></script>
	...
	<cfoutput>
	 <br>
	  <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   <tr>
	       <td class="tdheader">Rep Update Program</td>
	      </tr>
	   </table>           
