<cfform name="Phidlookup" action="dsp_PhidLookup.cfm?##Edit" method="POST">
	    <input type="hidden" name="Lookup" value="1">
		  <table border="0" cellpadding="4" cellspacing="0" width="100%" align="center">
			<tr>
			   <td align="center" class="PhidLookupTable">Use the form below to lookup a physician by PHID number. Once we have found the physician, you can change or inactivate their address.</td>
			</tr>
			<tr>
		       <td align="center">    
					 ...
					 <tr>
					    <td bgcolor="#ffffff">
						   <table border="0" cellpadding="4" cellspacing="0" width="100%">
						     <tr>
			                   <td align="center" colspan="2"><strong style="color:#003366;font-family:arial;font-size:14px;">Lookup Physician Address</strong></td>
			                 </tr>
							 <tr>
