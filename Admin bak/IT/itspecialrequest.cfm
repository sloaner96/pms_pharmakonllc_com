...
<!---	<CFLOOP query="qprojects"><cfoutput>
	#client_proj#, #description#, #client_code# </cfoutput><br>
		...
		<br>
		<FORM action="itspecialrequestaction.cfm" method="post">
		<TABLE BGCOLOR="#000080" ALIGN="center" BORDER="0" CELLPADDING="3" CELLSPACING="1" WIDTH="600">
		<TR>
			<TD CLASS="tdheader">IT Create Special Request</TD>
		</TR>		
		<TR>
			<TD>
				...
				<TR ALIGN="left">
					...
					<td align="left" colspan="2">CC yourself:<input type="checkbox" name="cc_torequestedby" value="" class="invis"></td>
				</TR>
				<TR ALIGN="left">
				...
				<TR ALIGN="left">
					<td align="center" colspan="4">
					<textarea cols="75" rows="5" name="comments" onkeyup="return _checkLimitContent(this)"></textarea>
					</td>
				</TR>
				<TR ALIGN="left">
					<td colspan=4><hr noshade></td>
