...
<FORM ACTION="act_weeklyReportsSetup.cfm?a=u" METHOD="post" name="get_client" onsubmit="return Verify(this);">
	...
	<tr>		
		...
		<td align="left"><input type="checkbox" <cfif s1 EQ 1>CHECKED</cfif> name="fchkS1" onclick="showhide('s1layer'); return(true);"></td>
		</div>
	</tr>
	</table>
	...
	<tr>		
		...
		<td align="left"><input type="checkbox" <cfif s2 EQ 1>CHECKED</cfif> name="fchkS2" onclick="showhide('s2layer'); return(true);"></td>
		</div>
	</tr>
	</table>
