...
<!--- Default case to present edit selection form to user --->
	<CFCASE VALUE="go_edit">
		<CFSET session.client_code2 = form.client_code2>
		<CFSET session.project_code2 = form.project_code2>
		<cfoutput>#form.project_code2#</cfoutput>
	<!----   case go edit <CFOUTPUT><META HTTP-EQUIV="REFRESH" CONTENT="0; URL=#form.edit_action#"></CFOUTPUT>----->
	<html>
	<head>
	<script>
	...
	<title>Clone Weekly Reports</title>
	<link href="simple.css" rel="stylesheet" type="text/css">
	</head>
	<body id="main">

<cfoutput>#application.WeeklyRptDSN#</cfoutput>
	...
	<FORM ACTION="Depreicated/rpt_weeklyReportsSetup_action.cfm?a=c" METHOD="post" name="get_client" onsubmit="return Verify(this);">


					<h2>Clone Project Information (<cfoutput>#session.project_code# to #session.project_code2#</cfoutput>)</h2>
	...
	<!--- 				<p>The new <code>&lt;div&gt;</code> content wrapper introduced in this example uses the <code>.box</code> class which sets the <code>background-color</code>, <code>padding</code>, and <code>border</code> properties for this object. The <code>background-color</code> property is critical, since it masks the underlying shadow.</p>	--->
					...
					<div class="bigquestion"><img src="images/red_arrow_9x9.gif">Program Name: <input type="text" name="fProgramName" VALUE=""> <br>
					</div>
...
<div class="main">
<h1>Weekly Reports Setup</h1>
<FORM ACTION="rpt_weeklyReportsSetup_clone.cfm?action=go_edit" METHOD="post" name="get_client" onsubmit="return Verify(this);">
<div class="wrap1">
	<div class="wrap2">
		<div class="wrap3">
			<div class="box">
				<h2>Project Code Select</h2>
