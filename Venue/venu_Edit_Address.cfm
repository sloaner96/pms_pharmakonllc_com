...
<cfform action="venu_Edit_Address_Action.cfm?venue_id=#venue_id#&add_id=#add_id#&no_menu='1'" method="POST" enablecab="No">
<table width="100%" border="0" cellspacing="2" cellpadding="2">
<tr BGCOLOR="eeeecc">
	<td><b>Venue ID:</b></td>
	<TD><cfoutput>#venue_id#</cfoutput></td>
</tr>
<tr BGCOLOR="eeeecc">
	<td><b><font color="Navy">Mail To Address:</font></b></td>
	<TD>
	<cfinput type="Text" name="mailtoadd_1" value="#url.mailtoadd_1#" message="Address is Required" required="No" size="50"></td>
</tr>
<tr BGCOLOR="eeeecc">
	<td></td>
	<TD>
	<cfinput type="Text" name="mailtoadd_2" value="#url.mailtoadd_2#"size="50"></td>
</tr>
<tr BGCOLOR="eeeecc">
	<td></td>
	<TD>
	<cfinput type="Text" name="mailtoadd_3" value="#url.mailtoadd_3#"size="50"></td>
</tr>
<tr BGCOLOR="eeeecc">
	<td align="right"><b>City:&nbsp;</b></td>
	<TD>
	<cfinput type="Text" name="mailtocity" value="#url.mailtocity#" message="City is Required" required="No" size="40"></td>
</tr>
<tr>
	<td align="right" bgcolor="#EEEECC"><b>State:&nbsp;</b></td>	
	<TD BGCOLOR="eeeecc">
	<cfselect name="mailtostate" message="State is Required" required="No">
			<OPTION value="">(Select)
			<CFOUTPUT query="qstate">
			<OPTION value="#qstate.code#"<cfif #trim(qstate.code)# is #trim(url.mailtostate)#> Selected </cfif>>#qstate.description#
			</cfoutput>
			</cfselect></td>
</tr>	
<tr><td align="right" bgcolor="#EEEECC"><b>Zip:&nbsp;</b></td>
	<TD BGCOLOR="eeeecc"><cfinput type="Text" name="mailtozip" value="#url.mailtozip#"  required="No" size="10"></td>
</tr>
<tr BGCOLOR="eeeecc">
	<td align="right" bgcolor="#EEEECC"><b>Country</b></td>
	<TD>
	<cfinput type="Text" name="mailtocountry" value="#url.mailtocountry#"size="35"></td>
</tr>
<tr>
	<td colspan="2">&nbsp;</td>
</tr>
...
<tr BGCOLOR="eeeecc">
	<td></td>
	<TD>
	<cfinput type="Text" name="bustoadd_2" value="#url.busadd_2#"size="50"></td>
</tr>
<tr BGCOLOR="eeeecc">
	<td></td>
	<TD>
	<cfinput type="Text" name="bustoadd_3" value="#url.busadd_3#"size="50"></td>
</tr>
<tr BGCOLOR="eeeecc">
	<td align="right"><b>City:</b>&nbsp;</td>
	<TD>
...
<tr BGCOLOR="eeeecc">
	<td align="right" bgcolor="#EEEECC"><b>Country</b></td>
	<TD>
	<cfinput type="Text" name="buscountry" value="#url.buscountry#"size="35"></td>
</tr>
</table>
