...
<cfform action="venu_edit_phone_action.cfm?venue_id=#URLEncodedFormat(venue_id)#&phone_id=#URLEncodedFormat(phone_id)#&no_menu='1'" method="POST" enablecab="Yes">
<table width="80%" border="0" cellspacing="2" cellpadding="2">
<tr>
	<td><b>Venue ID:&nbsp;&nbsp;</b><cfoutput>#venue_id#</cfoutput></td>
