...
<!----------------------------------------------------------------------------
	venu_Add_Comment.cfm
	Add a new comment for a venue. Comments include a date, type and memo area
...
<cfform action="venu_add_comment_action.cfm?venue_id=#URLEncodedFormat(venue_id)#&sortby=#sortby#&order=#order#&no_menu='1'" method="POST" enablecab="Yes">
