...
--->
<head>
	<title>Edit Venue Comment</title>
	<style>
...
<cfform action="venu_edit_comment_action.cfm?venue_id=#URLEncodedFormat(venue_id)#&comment_id=#URLEncodedFormat(comment_id)#&sortby=#URLEncodedFormat(sortby)#&order=#URLEncodedFormat(order)#&no_menu='1'" method="POST" enablecab="Yes">
...
<td width="83" align="center" valign="top"><a href="venu_comments_details.cfm?venue_id=#venue_id#&no_menu='1'" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('Backbtn','','images/Backbtn_f2.gif',1);"><img name="Backbtn" src="images/Backbtn.gif" width="24" height="23" border="0"><br><b>back</b><!-- fwtable fwsrc="bluebtn.png" fwbase="Backbtn.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
</a></td>
<i><b><td width="83" align="center" valign="top">
<a href="venu_Delete_Comment.cfm?comment_id=#comment_id#&venue_id=#venue_id#&sortby=#sortby#&order=#order#" onClick="return checkOut();" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('Deletebtn','','images/Deletebtn_f2.gif',1);"><img name="Deletebtn" src="images/Deletebtn.gif" width="26" height="23" border="0"><br><b> delete comment</b><!-- fwtable fwsrc="redbtn.png" fwbase="Deletebtn.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
</a></td>
</tr>
</cfoutput>
</table>
