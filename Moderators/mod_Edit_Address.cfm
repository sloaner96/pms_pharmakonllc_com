...
--------------------------------------------------------------------------------->
<head>
	<title>Edit Moderator Address</title>
...
<cfoutput>
<BODY bgcolor="##dbe3e5" onLoad="MM_preloadImages('/images/Deletebtn_f2.gif');MM_preloadImages('/images/Backbtn_f2.gif');MM_preloadImages('/images/savebtn_f2.gif');">
</cfoutput>
...
<cfform action="mod_Edit_Address_action.cfm?speakerid=#speakerid#&add_id=#add_id#&no_menu='1'" method="POST" enablecab="No">
...
<tr><td align="right" bgcolor="#eeeeee"><b>Zip:&nbsp;</b></td>
	<TD BGCOLOR="#eeeeee"><cfinput type="Text" name="zipcode" value="#url.zipcode#" required="No" size="10"></td>
</tr>
<tr BGCOLOR="#eeeeee">
...
<tr><td align="right" bgcolor="#eeeeee"><b>Zip:</b>&nbsp;</td>
	<TD BGCOLOR="#eeeeee"><cfinput type="Text" name="buszip" value="#url.buszip#" required="No" size="10"></td>
</tr>
<tr BGCOLOR="#eeeeee">
	<td align="right"><b>Country:&nbsp;</b></td>
	<TD><cfinput type="Text" name="buscountry" value="#url.buscountry#" size="35"></td>
</tr>
</table>
