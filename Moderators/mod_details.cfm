...
<br>
<p>Click on edit to update information about the Moderator.</p>
			...
			<table border="0" cellspacing="0" cellpadding="2" align="center" width="100%">
				<cfoutput query="qdetails">
				  <tr>
					 ...
					 <td></td>
					 <td colspan="3"><b style="font-size:14px;">#qdetails.firstname#&nbsp;#qdetails.middlename#&nbsp;#qdetails.lastname#&nbsp;#qdetails.degree#&nbsp;&nbsp;</b><A HREF="mod_edit.cfm?speakerid=#qdetails.speakerid#"><u><strong>[Edit]</strong></u></a></td>
					</tr>
					<tr BGCOLOR="##eeeeee">
