...
<form method="POST" action="edit_mod_clients.cfm?speakerid=#url.speakerid#">
...
<cfform method="POST" action="edit_mod_clients.cfm?speakerid=#url.speakerid#">
...
<br><br>
<input type="hidden" name="new_mod" value="#url.speakerid#">
