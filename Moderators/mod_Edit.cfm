...
<cfoutput><form name="AddMod" action="mod_Edit_Action.cfm" method="POST">
<table width="100%" border="0" cellspacing="0" cellpadding="4">
	...
	<tr>
		...
		<td colspan="3"><br>
		<a href="javascript:openpopup4('edit_mod_clients.cfm?speakerid=#url.speakerid#')"><u>Click Here</u></a> <em>to edit Clients and Fee's</em><br><br>
