...
//-->
	...
	<title>Moderator Comments Details</title>
	<style>
...
<table border="0" cellspacing="2" cellpadding="0">
	...
	<cfform name="Sort" action="mod_comments_details.cfm?speakerid=#speakerid#&no_menu='1'" method="POST">
