...
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="Add Moderator" showCalendar="1">
...
<cfoutput><form name="AddMod" action="mod_AddModAction.cfm" method="POST">
