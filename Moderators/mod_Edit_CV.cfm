...
--->
<head>
	<title>Edit Moderator CV/W9 Date</title>
	<style>
...
<cfform action="mod_Edit_cv_action.cfm?speakerid=#URLEncodedFormat(speakerid)#&no_menu='1'" method="post" name="calform" enablecab="Yes">
<cfoutput>
