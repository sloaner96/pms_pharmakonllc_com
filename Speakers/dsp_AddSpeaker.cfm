...
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="Add Speaker" showCalendar="1">
...
<cfoutput><form name="AddSpeaker" action="spkr_AddSpeakerAction.cfm" method="POST">
<table width="100%" border="0" cellspacing="0" cellpadding="4">
	...
	<strong>Middle Init:</strong>&nbsp;<input type="Text" name="middlename"  size="1" maxlength="3" value="">
		</td>
	</tr>
	<tr BGCOLOR="eeeeee">
	...
	<tr>
		...
		<td colspan="4">
			<input type="Text" name="degree" size="25" value="">
		</td>
	</tr>
		<tr BGCOLOR="eeeeee">
	...
	<tr BGCOLOR="eeeeee">
		...
		<td colspan="4" valign="top">
			<textarea cols="60" rows="5" name="affil" onkeyup="return _checkLimitContent(this)"></textarea> 
		</td>
	</tr>
	<!--- <tr>
...
<td align="left" valign="top"><font face="verdana" size="1">
<font face="verdana" size="1" color="maroon">#DollarFormat(all_prods.EventFee)#</font></td>
<td align="left" valign="top"><font face="verdana" size="1">
<font face="verdana" size="1" color="maroon">#DollarFormat(all_prods.trainingFee)#</font></td>
</tr>
</cfloop>
</table>
	...
	<tr BGCOLOR="eeeeee">
		<td></td>
		<td colspan="3">
			<input type="Text" name="address3" size="35" value="">
		</td>
	</tr>
	<tr BGCOLOR="eeeeee">
		...
		<input type="Text" name="city" size="35" value="">&nbsp;&nbsp;
			...
			</select>&nbsp;&nbsp;<input type="Text" name="zipcode" size="10" value="">
		</td>
	</tr>
	<tr BGCOLOR="eeeeee">
	...
	<tr BGCOLOR="eeeeee">
		<td colspan="4">Same as Mail To Address: <input type="Checkbox" name="shipsameaddress" checked="Yes" value="yes" visible="Yes" enabled="Yes"></td>
	</tr>
	
	<tr BGCOLOR="eeeeee">
		<td><strong>Shipping Address:</strong></td>
		<td colspan="3">
			<input type="Text" name="shipaddress1" size="35" value="">
		</td>
	</tr>
	<tr BGCOLOR="eeeeee">
		<td></td>
		<td colspan="3">
			<input type="Text" name="shipaddress2" size="35" value="">
		</td>
	</tr>
	<tr BGCOLOR="eeeeee">
		<td></td>
		<td colspan="3">
			<input type="Text" name="shipaddress3" size="35" value="">
		</td>
	</tr>
	<tr BGCOLOR="eeeeee">
		<td><strong>City/State/Zip:</strong></td>
		<td colspan="3">
		<input type="Text" name="shipcity" size="35" value="">&nbsp;&nbsp;
			<select name="shipstate">
			<OPTION value="">(Select)
			<cfloop query="qstate">
			<option value="#qstate.code#">#qstate.description#
			</cfloop>
			</select>&nbsp;&nbsp;<input type="Text" name="shipzipcode" size="10" value="">
		</td>
	</tr>
	<tr BGCOLOR="eeeeee">
		<td><strong>Country:</strong></td>
	...
	<tr>	
		...
		<td><input type="Text" name="phone1" size="25" value=""></td>
		<td colspan="2"></td>
	</tr>
	<tr>	
		<td align="right"><strong>Phone2:</strong></td>
		<td><input type="Text" name="phone2" size="25" value=""></td>
		<td colspan="2"></td>
	</tr>
	<tr>
		<td align="right"><strong>Fax1:</strong></td>
		<td><input type="Text" name="fax1" size="25" value=""></td>
		<td colspan="2"></td>
	</tr>
	<tr>
		<td align="right"><strong>Fax2:</strong></td>
		<td><input type="Text" name="fax2" size="25" value=""></td>
		<td colspan="2"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="Text" name="pager" size="25" value=""></td>
		<td colspan="2"></td>
	</tr>
	
		<td align="right"><strong>Primary E-Mail:</strong></td>
		<td><input type="Text" name="email1" size="25" value=""></td>
		<td colspan="2"></td>
	</tr>
	<tr>
		<td align="right"><strong>Secondary Email:</strong></td>
		<td><input type="Text" name="email2" size="25"  value=""></td>
		<td colspan="2"></td>
	</tr>
	...
	<tr BGCOLOR="eeeeee">
		...
		<td colspan="4">
			...
			<input type="text" 
			   ...
			   value="" 
			   size="10" maxlength="10">&nbsp;&nbsp;<em>e.g 1/1/2006</em>
