...
<!----------------------------------------------------------------------------
	spkr_Add_Comment.cfm
	Add a new comment for a speaker. Comments include a date, type and memo area
...
<html>
<head>
	<title>Add Speaker Comment</title>
	<style>
...
<!--
//limit comment to only 500 chars
...
<cfform action="spkr_add_comment_action.cfm?speakerid=#URLEncodedFormat(speakerid)#&sortby=#sortby#&order=#order#&no_menu='1'" method="POST" enablecab="Yes">

<table width="80%" border="0" cellspacing="2" cellpadding="2">
	<tr BGCOLOR="eeeecc">
		<th><b>Speaker ID:</b></th>
