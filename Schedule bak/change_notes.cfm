...
<!--- Default case to present edit selection form to user --->
	<CFCASE VALUE="go_edit">
		...
		<cflocation URL="#form.edit_action#" addtoken="NO">
	</CFCASE>
	<CFDEFAULTCASE>
		...
		select meeting_type_description, rtrim(meeting_type_value)  
		from meeting_type
		</CFQUERY>
...
<FORM ACTION="change_notes.cfm?action=go_edit" METHOD="post" name="get_client" onsubmit="return Verify(this);">
<div class="wrap1">
	<div class="wrap2">
		<div class="wrap3">
			<div class="box">
				...
				<div>
					<!--- create dynamically populated select boxes with this custom tag --->
							<select class="center" name="project_status" onLoad="this.form.project_status.options[0].value" onChange="setOptions(this.form, this.form.product, getOptions[this[this.selectedIndex].value]); setOptions(this.form, this.form.project_code, null)" tabindex="1" accesskey=""><option value="">Select Project Status</option>
							<option value="">---------------</option>
				...
				<div>
							<INPUT TYPE="hidden" NAME="edit_action" VALUE="change_notes2.cfm">
