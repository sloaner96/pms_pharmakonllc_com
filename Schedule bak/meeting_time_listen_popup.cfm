<!--- 
	*****************************************************************************************
	Name:		meeting_time_listen_popup.cfm
	Function:	Allows user to add/delete listen ins.
	History:	Matt Eaves -- Initial Code -- 11/01/02
				12/31/02 - Matt Eaves - Added code to insert speaker_client_rowid.
...
<TITLE>Add/Delete Listen-Ins</TITLE>
...
function DeleteListenSpkr(oTarget)
{
	...
	var message = "Are you sure you want to delete this listener?"
...
<CENTER>
<div style="font-size: 14px; font-family: arial; font-weight: bold; padding-bottom: 5px; color: navy;" width="100%">Add Listen Ins <CFOUTPUT>#URL.month#/#URL.day#/#URL.year#</CFOUTPUT></div>
...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" width="400px" style="text-align: left; margin-top: 8px;">
	...
	<TR>
		<TD style="padding-top: 8px;"><strong>Add Moderators Listen Ins</strong></TD>
		<form method="post" action="meeting_time_listen_action.cfm?type=mod&no_menu=1" onsubmit="return CheckModAdd(this)">
		<cfoutput>
	...
	<TR>
		<TD style="padding-top: 10px;"><strong>Add Speaker Listen Ins</strong></TD>
		<form method="post" action="meeting_time_listen_action.cfm?type=spkr&no_menu=1" onsubmit="return CheckSpkrAdd(this)">
			<cfoutput>
				<input type="hidden" name="UniqueID" value="#Row_ID#">
				<input type="hidden" name="meeting_code" value="#meeting_code#">
				<input type="hidden" name="txtYear" value="#year#">
...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" width="350px" style="text-align: left;">
	...
	<TR>
		<TD><strong>Current Moderator Listen Ins:</strong>&nbsp; &nbsp;</td>
		<TD>
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<CFQUERY DATASOURCE="#application.projdsn#" NAME="GetModListens">
						SELECT staff_id, rowid, client_rowid
						FROM schedule_meeting_time
						WHERE meeting_code = '#meeting_code#' AND staff_type = 3
					</CFQUERY>
					<cfif #GetModListens.recordcount#>
						<cfloop query="GetModListens">
							<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="GetModeratorName">
								SELECT sc.owner_id, sc.fee, st.firstname, st.lastname 
								FROM spkr_table st, speaker_clients sc
								WHERE sc.rowid = #GetModListens.client_rowid#
								AND sc.owner_id = st.speaker_id
								ORDER BY lastname, firstname;
							</CFQUERY>
							<cfoutput>
							<form action="meeting_time_listen_delete.cfm?&no_menu=1" method="post" name="DeleteModFrm">
								<td>
									<input type="hidden" name="deleteID" value="#GetModListens.staff_id#">
									<input type="hidden" name="meeting_code" value="#meeting_code#">
									...
									<input type="hidden" name="MilitaryTimeBegin" value="#MilitaryBegin#">
									<input type="hidden" name="MilitaryTimeEnd" value="#MilitaryEnd#">
									<input type="hidden" name="listeninUnique" value="#GetModListens.rowid#">
	...
	<tr>
		<TD><strong>Current Speaker Listen Ins:</strong>&nbsp; &nbsp; &nbsp;</td>
		<TD>
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<CFQUERY DATASOURCE="#application.projdsn#" NAME="GetSpkrListens">
						SELECT staff_id, rowid, client_rowid
						FROM schedule_meeting_time
						WHERE meeting_code = '#meeting_code#' AND staff_type = 6
					</CFQUERY>
					<cfif #GetSpkrListens.recordcount#>
						<!---to avoide confusion between variables and query objects going to set a temp variable here---->
						<cfloop query="GetSpkrListens">
							<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="GetSpeakerName">
								SELECT sc.owner_id, sc.fee, st.firstname, st.lastname 
								FROM spkr_table st, speaker_clients sc
								WHERE sc.rowid = #GetSpkrListens.client_rowid#
								AND sc.owner_id = st.speaker_id
								ORDER BY lastname, firstname;
							</CFQUERY>
							<cfoutput>
							<form action="meeting_time_listen_delete.cfm?&no_menu=1" method="post" name="DeleteSpkrFrm">
								<td>
									<input type="hidden" name="deleteID" value="#GetSpkrListens.staff_id#">
									<input type="hidden" name="UniqueID" value="#temp_rowid#">
									<input type="hidden" name="meeting_code" value="#meeting_code#">
									<input type="hidden" name="txtYear" value="#year#">
									<input type="hidden" name="txtMonth" value="#month#">
									...
									<input type="hidden" name="MilitaryTimeBegin" value="#MilitaryBegin#">
									<input type="hidden" name="MilitaryTimeEnd" value="#MilitaryEnd#">
									<input type="hidden" name="listeninUnique" value="#GetSpkrListens.rowid#">
