<!----------
meeting_time_speaker_delete.cfm
...
<CFQUERY DATASOURCE="#application.projdsn#" NAME="UpdateListens">			
	DELETE FROM schedule_meeting_time WHERE rowid = #form.SpeakerUnique#
</CFQUERY>

<cfoutput>
	<cflocation url="meeting_time_speaker_popup.cfm?no_menu=1&year=#form.txtYear#&month=#form.txtMonth#&day=#form.txtDay#&time=#RegTime#&modID=#ModerID#&spkrID=#SpkerID#&uniqueID=#UniqueID#&modRowID=#form.intModRow#&spkrRowID=#form.intSpkrRow#&beginM=#MilitaryTimeBegin#&EndM=#MilitaryTimeEnd#&meeting_code=#form.meeting_code#" addtoken="no">
</cfoutput>
