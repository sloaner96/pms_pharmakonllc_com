<!----------
meeting_time_training_delete.cfm

Sets trainees time back to available and deletes the record from trainee table
-------------->
...
<CFQUERY DATASOURCE="#application.projdsn#" NAME="DeleteTraining">			
