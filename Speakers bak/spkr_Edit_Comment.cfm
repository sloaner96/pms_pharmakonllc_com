...
--->
<head>
	<title>Edit Speaker Comment</title>
	<style>
...
//limit length of comment to 500 chars
	function  _checkLimitContent(_CF_this)
	{
		if (_CF_this.value.length > 499)
		{
...
<cfform action="spkr_edit_comment_action.cfm?speakerid=#URLEncodedFormat(speakerid)#&comment_id=#URLEncodedFormat(comment_id)#&sortby=#URLEncodedFormat(sortby)#&order=#URLEncodedFormat(order)#&no_menu='1'" method="POST" enablecab="Yes">
