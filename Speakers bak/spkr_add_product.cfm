...
<!---Grab an array of all clients assigned to this speaker---->
...
<cfoutput>
<form name="client_add" action="spkr_add_product_action.cfm?speakerid=#url.speakerid#&no_menu='1'"  onSubmit="return CheckFields(this)" method="post">
</cfoutput>
