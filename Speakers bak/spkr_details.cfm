			...
			<table border="0" cellspacing="0" cellpadding="2" align="center" width="100%">
				<cfoutput query="qdetails">
				  <tr>
					 ...
					 <td></td>
					 <td colspan="3"><A HREF="spkr_edit.cfm?speakerid=#qdetails.speakerid#"><b style="font-size:14px;">#qdetails.firstname#&nbsp;#qdetails.middlename#&nbsp;#qdetails.lastname#&nbsp;#qdetails.degree#</b></a></td>
					</tr>
					<tr BGCOLOR="##eeeeee">
