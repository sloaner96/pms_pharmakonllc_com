...
//-->
	...
	<title>Speaker Comments Details</title>
	<style>
...
<cfquery name="qcomments" datasource="#application.speakerDSN#">
	...
	FROM    comments
	WHERE   comments.speakerid = #speakerid# AND comments.type = 'SPKR'
...
<table border="0" cellspacing="2" cellpadding="0">
	...
	<cfform name="Sort" action="spkr_comments_details.cfm?speakerid=#speakerid#&no_menu='1'" method="POST">
