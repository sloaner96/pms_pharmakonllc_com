...
<!--- <CFQUERY DATASOURCE="#Application.projdsn#" NAME='getListenIns' USERNAME='#session.dbu#' PASSWORD='#session.dbp#'>
	...
	FROM listen_ins l, schedule_meeting_time smt
...
<!--- <CFQUERY DATASOURCE="#Application.projdsn#" NAME='getTrainees' USERNAME='#session.dbu#' PASSWORD='#session.dbp#'>
	...
	FROM training t, schedule_meeting_time smt
...
<cfif #getMeetings.recordcount#>
	...
	<CFQUERY DATASOURCE="#application.SpeakerDSN#" NAME='getModerator'>
		...
		FROM spkr_table
		WHERE speaker_id = #form.moderator#
	</CFQUERY>
	...
	<cfoutput>
		...
		<cfset x = #x# + 1>
		<cfset OutputArray[x] = "<p><strong>Address:</strong><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#getModAddress.mailtoadd_1#<br>">
		<cfset x = #x# + 1>
		
		<cfif #getModAddress.mailtoadd_2# NEQ ''>
			<cfset OutputArray[x] = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#getModAddress.mailtoadd_2#<br>">
			<cfset x = #x# + 1>
		</cfif>
		<cfif #getModAddress.mailtoadd_3# NEQ ''>
			<cfset OutputArray[x] = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#getModAddress.mailtoadd_3#<br>">
			<cfset x = #x# + 1>
		</cfif>
			
		<cfset OutputArray[x] = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#getModAddress.mailtocity#, #getModAddress.mailtostate# #getModAddress.mailtozip#</p><p><strong>Phone Number:</strong> &nbsp; #getModPhone.phone1#</p>">
		<cfset x = #x# + 1>
