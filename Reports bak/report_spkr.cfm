			...
			<BODY BGCOLOR="FFFFFF" MARGINHEIGHT="0" MARGINWIDTH="0">
				...
				<TABLE ALIGN="left" BORDER="0" CELLPADDING="5" CELLSPACING="5">
					...
					<CFQUERY DATASOURCE="#application.projdsn#" NAME="meetingDT">
						...
						WHERE status = 0 AND speaker_id = '#session.id#' AND month BETWEEN <CFOUTPUT>#begin_month#</CFOUTPUT> AND <CFOUTPUT>#end_month#</CFOUTPUT> AND year BETWEEN <CFOUTPUT>#begin_year#</CFOUTPUT> AND <CFOUTPUT>#end_year#</CFOUTPUT>
