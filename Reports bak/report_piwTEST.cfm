...
<cfoutput query="qpiw">
			...
			<td>
				<cfloop query="qmods">
					...
					<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="qminfo">
						SELECT firstname, lastname FROM  spkr_table WHERE speaker_id = #qmods.moderator_id# 
					</cfquery>
	...
	<tr BGCOLOR="#e5f6ff">
		...
		<CFLOOP QUERY="get_mod_id">
			<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="get_name">
				SELECT firstname, lastname FROM spkr_table WHERE speaker_id = #get_mod_id.moderator_id#
			</CFQUERY>
	...
	<tr>
		...
		<CFLOOP QUERY="get_spkr_id">
			<CFQUERY DATASOURCE="#application.speakerDSN#" NAME="get_name">
				SELECT firstname, lastname FROM spkr_table WHERE speaker_id = #get_spkr_id.speaker_id#
			</CFQUERY>
			<CFLOOP QUERY="get_name">
				#get_name.firstname# #get_name.lastname#<br>
			</CFLOOP>
