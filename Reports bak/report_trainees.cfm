...
------------------------->
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="Trainees Report" showCalendar="1">
...
function OpenHTMLReport()
{
	...
	{
		document.forms[0].action = "report_trainees2.cfm?report=HTML";
...
function OpenExcelReport()
{
	...
	{
		document.forms[0].action = "report_trainees2.cfm?report=Excel&no_menu=1";
		document.forms[0].submit();
	}
}
</script>
...
<form action="report_trainees2.cfm" method="post" onsubmit="return CheckDates(this)">		
