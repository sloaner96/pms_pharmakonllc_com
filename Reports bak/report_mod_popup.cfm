		...
		<BODY BGCOLOR="White" MARGINHEIGHT="0" MARGINWIDTH="0">
				...
				<TABLE ALIGN="left" WIDTH="650" BORDER="0" CELLPADDING="5" CELLSPACING="5">
					...
					<CFQUERY DATASOURCE="#application.projdsn#" NAME="meetingDT">
						...
						WHERE moderator_id = '#session.id#' AND month BETWEEN <CFOUTPUT>#session.begin_month#</CFOUTPUT> AND <CFOUTPUT>#session.end_month#</CFOUTPUT> AND year BETWEEN <CFOUTPUT>#session.begin_year#</CFOUTPUT> AND <CFOUTPUT>#session.end_year#</CFOUTPUT>
