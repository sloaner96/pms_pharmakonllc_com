...
--->
<cfmodule template="#Application.tagpath#/ctags/header.cfm" title="Work on a Project" bodyPassthrough="onLoad='init()'" doAjax="True">
...
<cfinvoke component="pms.com.utilities" method="getCompany" returnvariable="getCompanies">
			...
			<script language="javascript">
				...
				{
					var Series = DWRUtil.getValue("program");
					var sendTo = "/projects/dsp_reportPIW.cfm?project_code=" + Series;
...
<table border="0" cellpadding="3" cellspacing="0" width="500" align="center">
  <tr>
	...
	<tr>
	  <td align="center" colspan="2"><input type="submit" name="submit" id="submitbtn" value="Work on Project" style="visibility: hidden;" onClick="goToProject();"></td>
	</tr>
  </table>
</cfoutput>
